...
void betacdf_cuda(const double *x, double *y, const double *alpha, const double *beta, unsigned long data_size, unsigned long betas_size, Memory_Type memory_type=Memory_Type::HOST);